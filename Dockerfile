...
FROM debian:jessie
LABEL maintainer="robdyke@gmail.com"
...
# Add key and sources for gosu and debian.m9s.biz
...
RUN curl -o /etc/apt/debian.tryton.org-archive.asc -SL "https://debian.m9s.biz/debian/debian.tryton.org-archive.asc" \
	&& apt-key add /etc/apt/debian.tryton.org-archive.asc \
	&& curl -o /etc/apt/sources.list.d/tryton-jessie-$T_MAJOR.list https://debian.m9s.biz/debian/tryton-jessie-3.4.list \
	&& curl -o /etc/apt/preferences.d/debian.m9s.biz.pref -SL "https://debian.m9s.biz/debian/debian.tryton.org.pref" \
